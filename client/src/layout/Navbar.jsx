...
const Navbar = () => {
  ...
  const fetchCartItem = async () => {
    try {
      ...
      const res = await axios.get('https://ecommerce-kboc.onrender.com/api/cart/getCart', {
        headers: {
...

          {
            loggedIn ? (
              <button
                ...
                className='text-xl cursor-pointer border rounded-[30px] py-2 px-9 hover:bg-[#f4f3f3] transition duration-200'
              >
                Logout
              </button>
            ) : (
